package net.vanillacrafters.bridgeyourlaunchers.config;
...
public final class AutoconnectConfig {
    ...
    public static AutoconnectConfig getInstance() {
        return instance;
    }
    ...
    public void save() {
        try {
            ...
            LogUtils.getLogger().error("Autoconnect could not save the config", ex);
        }
    }
